        ...
        <section className="profile-section" id="profile">
            ...
            <div className="profile-left">
                ...
                <div className="profile-socials" style={{ marginTop: '2.5rem', display: 'flex', gap: '1.2rem', alignItems: 'center' }}>
                    ...
                    <a href="https://www.linkedin.com/in/anjali-pise-8b76b9257/" className="social-icon-link" title="LinkedIn"><FaLinkedin size={28} /></a>
                    <a href="https://www.instagram.com/avp.1122/" className="social-icon-link" title="instagram"><FaInstagram size={28} /></a>
